...
PLAYERS_TO_TRACK = [
    {"name": "Player One",        "tag": "TAG1"},
    {"name": "Player Two",      "tag": "EUW"},
    {"name": "Player Three",      "tag": "TAG2"},
    {"name": "Player Four",            "tag": "EUW"},
    {"name": "Player Five",            "tag": "EUW"},
    {"name": "Player Six",      "tag": "EUW"},
    {"name": "Player Seven",  "tag": "333"},
    {"name": "Player Eight",           "tag": "212"},
    {"name": "Player Nine",         "tag": "MDR"},
]

# Catégories de joueurs (peut être chargé depuis un JSON externe)
PLAYER_CATEGORIES = {
    "ELT": {
        "players":    ["Player Eight", "Player Five"],
        "base":       30,
        "min_pompes": 15,
        "mult_mort":  18,
        "mult_kill":  18,
